    ...
    <section className="newsletter">
      <div className="newsletter__inner">
        <div className="newsletter__text">
          ...
          <h2 className="newsletter__title">Grow your brand with purpose</h2>
          <p className="newsletter__sub">
            Get exclusive marketing insights, strategy guides, and campaign updates delivered to your inbox.
          </p>
        </div>
